class AddPrLinePage {
    ...
    async addPurchaseRequisitionLine(testData) {
        ...
        await this.page.fill(this.enterQuantity, String(testData.quantity));
        await this.selectDropdown();
        await this.page.fill(this.priceInput, String(testData.price));
        ...
        // Optional: wait for toast to disappear (important)
