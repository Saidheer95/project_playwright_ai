...
class LoginPage {
  ...
  // async loginByRole(role, filePath = defaultCredentialsPath) {
  //   const credentials = loadCredentials(filePath);

  //   const user = credentials[role];

  //   if (!user) {
  //     throw new Error(`User role '${role}' not found in credentials file`);
  //   }

  //   await this.login(email, password);
  // }

  // async loginFromFile(filePath = defaultCredentialsPath) {
  //   const credentials = loadCredentials(filePath);
